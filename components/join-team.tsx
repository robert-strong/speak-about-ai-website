...
export default function JoinTeam({
  ...
  const buttonClassName = "inline-flex items-center justify-center px-8 py-4 text-lg font-montserrat text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-md"
  const buttonStyle = { background: "linear-gradient(to right, #f59e0b, #d97706)", color: "white" }
    ...
    return (
      <section className="py-20 bg-[#1E68C6]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href={`${CONTACT_FORM_PATH}?source=team_page`}
