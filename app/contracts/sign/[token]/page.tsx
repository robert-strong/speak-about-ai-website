...
import { CheckCircle, AlertCircle, FileText, Calendar, MapPin, DollarSign, Users, PenTool, RotateCcw, Loader2, Download, Printer } from "lucide-react"
...
export default function ContractSigningPage() {
  ...
  const handleSign = async () => {
    ...
    try {
      ...
      setSigned(true)
      toast({ title: "Contract Signed", description: "Your signature has been recorded and signed copies will be sent to all parties." })
      await loadContract()
    } catch (err) {
      toast({
        title: "Error",
        ...
        {can_sign && !signed && (
          <Card className="mt-8 print:hidden">
            <CardHeader className="bg-blue-50 border-b">
              ...
              <CardDescription>
                Please review the contract above, then provide your information and signature below.
              </CardDescription>
            </CardHeader>
