...
import {
  MapPin, Globe, Mail, Phone, Calendar, ArrowLeft,
  ExternalLink, Users, Building2, CheckCircle,
  TrendingUp, Linkedin, Image as ImageIcon
} from "lucide-react"
...
// Presentational half of the conference page. The server page (./page.tsx)
// loads the record and 404s when it does not exist, so this component never
// has to show a loading or not-found state.
export default function ConferenceDetailClient({ conference }: { conference: ConferenceDetail }) {
