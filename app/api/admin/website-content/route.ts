...
const DEFAULT_CONTENT = [
  ...
  { page: 'home', section: 'why-choose-us', content_key: 'feature1_highlights', content_value: JSON.stringify(["Innovators who built products used by billions", "Stanford & MIT faculty and researchers", "Former executives from OpenAI, Google, Meta, Amazon"]) },
  ...
  { page: 'home', section: 'why-choose-us', content_key: 'feature2_highlights', content_value: JSON.stringify(["Initial response: within 24 hours of inquiry", "Custom recommendations matched to your event needs", "Speaker availability check: we reach out to speakers immediately", "Contract finalization: 3-5 business days after speaker confirmation", "Typical booking timeline: 1-2 weeks for most engagements"]) },
  ...
  { page: 'home', section: 'why-choose-us', content_key: 'feature3_highlights', content_value: JSON.stringify(["Pre-event briefings: coordinate speaker prep calls with your team", "Technical checks: arrange and facilitate tech rehearsals", "On-site support: we attend events in-person where possible", "Multi-engagement coordination: ensure speaker availability for additional sessions", "Direct liaison: single point of contact throughout the entire process"]) },
  ...
  { page: 'home', section: 'why-choose-us', content_key: 'feature4_highlights', content_value: JSON.stringify(["Budget ranges: $5K-$20K (emerging experts) to $20K+ (industry leaders)", "Audience types: executives, engineers, entrepreneurs, medical professionals, public sector, academic institutions", "Global delivery: worldwide coverage + virtual/hybrid capabilities", "Custom recommendations within 24 hours of inquiry", "Our speakers tailor AI talk depth to your audience"]) },
  ...
  { page: 'home', section: 'why-choose-us', content_key: 'feature5_highlights', content_value: JSON.stringify(["Delivery styles: visionary storytellers, pragmatic operators, data-led strategists", "Venue experience: intimate boardrooms to 10,000+ stadium keynotes", "Context-aware messaging aligned to your audience & objectives", "Due diligence on sensitive topics (ethics, bias, job displacement)", "We brief speakers thoroughly to ensure appropriate tone & depth"]) },
  ...
  { page: 'home', section: 'why-choose-us', content_key: 'feature6_highlights', content_value: JSON.stringify(["Proven frameworks & ROI-focused implementation strategies", "Real-world case studies: documented metrics from Fortune 500 deployments", "Immediate action: tactical roadmaps your team can execute Monday morning", "Industry examples: productivity improvements, accelerated rollouts, cost optimization strategies", "Post-event resources: slides, recordings, follow-up Q&A sessions"]) },
