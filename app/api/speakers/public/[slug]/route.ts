...
export async function GET(
  ...
  try {
    ...
    const transformedSpeaker = {
      ...
      wikipedia: speaker.social_media?.wikipedia_url || '',
      googleScholar: speaker.social_media?.google_scholar_url || '',
      otherProfiles: Array.isArray(speaker.social_media?.other_urls) ? speaker.social_media.other_urls : [],
      ...
      awards: Array.isArray(speaker.awards) ? speaker.awards : [],
      pastEvents: Array.isArray(speaker.past_events) ? speaker.past_events : [],
      clientLogos: Array.isArray(speaker.client_logos) ? speaker.client_logos : [],
